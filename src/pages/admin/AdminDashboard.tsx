...
import { useGetAdminPostsQuery, useGetAdminPagesQuery, useGetPostAnalyticsQuery } from '@/store/api';
...
export default function AdminDashboard() {
  ...
  const { data: analytics, isLoading: analyticsLoading } = useGetPostAnalyticsQuery();

  if (postsLoading || pagesLoading || analyticsLoading) return null;
